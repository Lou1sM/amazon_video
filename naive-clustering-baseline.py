...
if ARGS.dset=='osvd':
    ...
    for vn, fps in osvd_vn2fps.items():
        ...
        method_preds = [get_baseline_preds(m, feats_ar, 22) for m in method_names]
    ...
    for vn in range(11):
        ...
        method_preds = [get_baseline_preds(m, feats_ar, 48) for m in method_names]
