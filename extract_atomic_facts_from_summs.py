...
def factscore_eval_ep(ep_name):
    maybe_cache = f'SummScreen/cached_chatgpt_facts/full_pred_summ_facts/{ep_name}.txt'
    summ_summ_path = f'SummScreen/full_summs/{ep_name}.txt'
    ...
    for summ_name, gt_summ in ep.summaries.items():
        if len(gt_summ)>5000:
            ...
            continue
        maybe_cache_gt = f'SummScreen/cached_chatgpt_facts/gt_summ_facts/{ep_name}-{summ_name}.txt'
